...
if not BOT_TOKEN:
    raise RuntimeError("BOT_TOKEN не найден. Создай файл .env и добавь BOT_TOKEN=твой_токен")
...
QUESTIONS = [
    {
        "text": "1/15. Что тебе больше нравится делать в свободное время?",
        "options": [
            ("Придумывать истории, рисовать, создавать что-то новое", "creative"),
            ("Разбираться, как что-то устроено — от механизмов до кода", "tech"),
            ("Общаться, помогать людям разбираться в проблемах", "people"),
            ("Решать логические задачи, головоломки, считать", "analytical"),
        ],
    },
    {
        "text": "2/15. В групповой работе тебе комфортнее всего...",
        "options": [
            ("Придумывать идею и вести команду за собой", "leadership"),
            ("Проверять детали и следить за качеством", "detail"),
            ("Предлагать необычные творческие решения", "creative"),
            ("Работать самостоятельно и показать готовый результат", "independent"),
        ],
    },
    {
        "text": "3/15. Какой тип задач тебе интереснее?",
        "options": [
            ("Работа с компьютерами, кодом и технологиями", "tech"),
            ("Общение, помощь и объяснение людям", "people"),
            ("Эксперименты, природа и научные исследования", "science"),
            ("Дизайн, музыка, видео и другие творческие задачи", "creative"),
        ],
    },
    {
        "text": "4/15. Что для тебя важнее в будущей работе?",
        "options": [
            ("Стабильность и понятный карьерный путь", "stability"),
            ("Свобода и возможность работать гибко", "freedom"),
            ("Высокий доход и возможность развиваться", "income"),
            ("Ощущение, что работа приносит пользу людям", "impact"),
        ],
    },
    {
        "text": "5/15. Если бы не было ограничений, ты бы...",
        "options": [
            ("Запустил(а) свой проект или стартап", "leadership"),
            ("Изучал(а) технологии и создавал(а) продукты", "tech"),
            ("Работал(а) с людьми: обучал(а), консультировал(а), помогал(а)", "people"),
            ("Создавал(а) искусство, дизайн, видео или медиа", "creative"),
        ],
    },
    {
        "text": "6/15. Как ты обычно подходишь к сложной задаче?",
        "options": [
            ("Разбиваю её на части и ищу закономерности", "analytical"),
            ("Сначала изучаю, как всё работает", "tech"),
            ("Обсуждаю задачу с другими и собираю идеи", "people"),
            ("Ищу нестандартный способ решения", "creative"),
        ],
    },
    {
        "text": "7/15. Что тебе ближе в работе?",
        "options": [
            ("Создавать новые идеи и проекты", "creative"),
            ("Работать с людьми и командой", "people"),
            ("Работать с цифрами, данными и фактами", "analytical"),
            ("Работать с техникой и технологиями", "tech"),
        ],
    },
    {
        "text": "8/15. Какой результат работы приносит тебе больше удовлетворения?",
        "options": [
            ("Красивый и оригинальный результат", "creative"),
            ("Точная работа без ошибок", "detail"),
            ("Решённая сложная задача", "analytical"),
            ("Результат, который помогает другим", "impact"),
        ],
    },
    {
        "text": "9/15. Какой формат работы тебе подходит больше?",
        "options": [
            ("Чёткие правила, структура и стабильность", "stability"),
            ("Свободный график и самостоятельность", "freedom"),
            ("Командная работа и постоянное общение", "people"),
            ("Самостоятельные проекты и ответственность за результат", "independent"),
        ],
    },
    {
        "text": "10/15. Что тебе интереснее изучать?",
        "options": [
            ("Программирование, компьютеры и новые технологии", "tech"),
            ("Психологию, общество и поведение людей", "people"),
            ("Биологию, химию, физику и природу", "science"),
            ("Дизайн, искусство, медиа и творчество", "creative"),
        ],
    },
    {
        "text": "11/15. Как ты относишься к риску в карьере?",
        "options": [
            ("Предпочитаю надёжность и предсказуемость", "stability"),
            ("Готов(а) рисковать ради высокого дохода", "income"),
            ("Мне важнее свобода, чем гарантии", "freedom"),
            ("Готов(а) рисковать ради собственного проекта", "leadership"),
        ],
    },
    {
        "text": "12/15. Что тебе легче всего даётся?",
        "options": [
            ("Находить ошибки и замечать мелкие детали", "detail"),
            ("Придумывать идеи и новые решения", "creative"),
            ("Организовывать людей и распределять задачи", "leadership"),
            ("Самостоятельно разбираться в новой теме", "independent"),
        ],
    },
    {
        "text": "13/15. Какая рабочая ситуация тебе ближе?",
        "options": [
            ("Нужно придумать новый продукт или концепцию", "creative"),
            ("Нужно проанализировать данные и найти причину проблемы", "analytical"),
            ("Нужно помочь человеку выбрать решение", "people"),
            ("Нужно настроить или разработать техническую систему", "tech"),
        ],
    },
    {
        "text": "14/15. Какой стиль работы тебе ближе?",
        "options": [
            ("Глубоко погружаться в одну задачу и доводить её до идеала", "detail"),
            ("Постоянно пробовать новое и менять подходы", "freedom"),
            ("Руководить процессом и принимать решения", "leadership"),
            ("Работать самостоятельно и отвечать за свой результат", "independent"),
        ],
    },
    {
        "text": "15/15. Что ты хотел(а) бы получить от будущей профессии?",
        "options": [
            ("Возможность постоянно учиться и развиваться", "tech"),
            ("Хороший доход и карьерные возможности", "income"),
            ("Пользу для людей и ощущение значимости", "impact"),
            ("Возможность создавать что-то своё", "creative"),
        ],
    },
]
